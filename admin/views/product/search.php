...
<div class="container">
	<span>KẾT QUẢ TÌM KIẾM "<?php echo $_SESSION['searchAdmin'] ?>"</span>

	<div class="search clear-fix">
		<form action="admin.php/product/search/" type="GET">
			<input id="myInput" type="text" name="s" placeholder="Search" value="<?php echo $_SESSION['searchAdmin'] ?>" required>
	...
	<div class="container-content">
		...
		<tbody>
			<?php
			if ($count > 0) {
			$stt = 0; foreach ($product as $items){ $stt++ ?>
			<tr>
				<td><?php echo $stt; ?></td>
